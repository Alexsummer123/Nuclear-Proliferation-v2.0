  ...
  return (
    ...
    >
      <div className="flex items-center justify-center h-full">
        <div className="bg-white bg-opacity-50 p-20 rounded-lg shadow-lg ">
          <h1 className="text-4xl font-bold mb-20 text-center font-custom">What if, <br></br>Chernobyl incident never happen? </h1>
